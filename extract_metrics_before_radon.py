...
cc_data  = rodar_radon(["radon", "cc",  "./aredis_om", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "./aredis_om", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "./aredis_om", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "./aredis_om", "-j"])
